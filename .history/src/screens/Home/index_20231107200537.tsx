        ...
        <View style={styles.content}>
          <View style={styles.contentHeader}>
            <View style={styles.contentHeaderLeft}>
              ...
              />
              <Text style={styles.contentHeaderLeftText}>Neymar C.</Text>
            </View>
            <View style={styles.contentHeaderLeft}>
              <Image
                style={styles.contentHeaderLeftImage}
              ...
              />
              <Text style={styles.contentHeaderLeftText}>Cristiano C.</Text>
            </View>
        ...
        <View style={styles.content}>
          <View style={styles.contentHeader}>
            <View style={styles.contentHeaderLeft}>
              ...
              />
              <Text style={styles.contentHeaderLeftText}>Messi C.</Text>
            </View>
            <View style={styles.contentHeaderLeft}>
              <Image
                style={styles.contentHeaderLeftImage}
              ...
              />
              <Text style={styles.contentHeaderLeftText}>Ney C.</Text>
            </View>
          ...
          <View style={styles.contentFooter}>
            ...
            <View style={styles.contentFooterTexts}>
              <Text
                style={[styles.contentFooterText1, styles.contentFooterText]}
              >
                La pelota de Óórr                              S(h)IIIIIU
              </Text>
              
              <Text 
                style={[styles.contentFooterText3, styles.contentFooterText]}
              >
                1 hora atrás                                                               7 horas atrás
              </Text>
            </View>
          </View>
        </View>
        <View style={styles.content}>
          <View style={styles.contentHeader}>
            <View style={styles.contentHeaderLeft}>
              ...
              />
              <Text style={styles.contentHeaderLeftText}>Mauricio C.</Text>
            </View>
            <View style={styles.contentHeaderLeft}>
              <Image
                style={styles.contentHeaderLeftImage}
              ...
              />
              <Text style={styles.contentHeaderLeftText}>Enner Violencia</Text>
            </View>
          ...
          <View style={styles.contentFooter}>
            ...
            <Text
                style={[styles.contentFooterText1, styles.contentFooterText]}
              >
                MauMau da unijui                             Dias de luta e dias de luta
              </Text>
              
              <Text 
                style={[styles.contentFooterText3, styles.contentFooterText]}
              >
                10 horas atrás                                                         13 horas atrás
              </Text>
            </View>
          </View>
        </View>
        <View style={styles.content}>
          <View style={styles.contentHeader}>
            <View style={styles.contentHeaderLeft}>
              ...
              />
              <Text style={styles.contentHeaderLeftText}>Calvo de cria</Text>
            </View>
            <View style={styles.contentHeaderLeft}>
              <Image
                style={styles.contentHeaderLeftImage}
              ...
              />
              <Text style={styles.contentHeaderLeftText}>Calvin</Text>
            </View>
